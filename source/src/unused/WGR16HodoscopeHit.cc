...
G4ThreadLocal G4Allocator<WGR16HodoscopeHit>* WGR16HodoscopeHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

WGR16HodoscopeHit::WGR16HodoscopeHit(G4int i,G4double t)
: G4VHit(), fId(i), fTime(t), fPos(0), fPLogV(0)
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

WGR16HodoscopeHit::~WGR16HodoscopeHit()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

WGR16HodoscopeHit::WGR16HodoscopeHit(const WGR16HodoscopeHit &right)
: G4VHit() {
    fId = right.fId;
    fTime = right.fTime;
    fPos = right.fPos;
...
const WGR16HodoscopeHit& WGR16HodoscopeHit::operator=(const WGR16HodoscopeHit &right)
{
    fId = right.fId;
    fTime = right.fTime;
    fPos = right.fPos;
...
int WGR16HodoscopeHit::operator==(const WGR16HodoscopeHit &/*right*/) const
{
    return 0;
}
