...
WGR16HodoscopeSD::WGR16HodoscopeSD(G4String name)
...
WGR16HodoscopeSD::~WGR16HodoscopeSD()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void WGR16HodoscopeSD::Initialize(G4HCofThisEvent* hce)
{
    fHitsCollection = new WGR16HodoscopeHitsCollection
...
G4bool WGR16HodoscopeSD::ProcessHits(G4Step* step, G4TouchableHistory*)
{
    ...
    {
        WGR16HodoscopeHit* hit = new WGR16HodoscopeHit(copyNo,hitTime);
